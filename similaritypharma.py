...
def validar(labeler):
    try:
        ...
        for row in mobile_records:
            ...
            dfRes = dfRes.append(new_rowFin, ignore_index=True)
            print(dfRes)
            dfRes.to_csv('/app/similarityPharmaNormEMEA.csv', encoding='utf-8', sep = '~')
